    ...
    return (
        <div className="px-10">
            <section className="mx-auto max-w-lg w-full pt-24">
                <h2 className="text-6xl max-w-[14ch] font-bold tracking-tighter">
                ...
                <button className="mt-8 flex items-center justify-center px-6 h-12 rounded-full border-3 border-dark-green bg-green-400 text-dark-green">
