        ...
        <div className="px-10 bg-green-300 py-20">
            <section className="mx-auto w-full max-w-lg">
                ...
                <p className="mt-10 text-xl font-semibold tracking-tighter max-w-[64ch]">
                    <span className="text-dark-green/60">Welcome to <span className="text-dark-green">FundDreamz</span>, your go-to platform for turning dreamz into reality. FundDreamz is a powerful crowdfunding platform that helps individuals, entrepreneurs, counities, organizations, and chirities raise funds for their goals and initiative. Whether you&apos;re seeking support for a personal need, a groundbreaking idea, a community project, aor a charitable cause, FundDreamz provides the tools and visibilty you need to bring your dream to life.</span>
                    <br />
